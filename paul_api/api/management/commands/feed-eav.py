...
class Command(BaseCommand):
    def handle(self, *args, **kwargs):
        ...
        for table_name, fields in tables_map.items():
            ...
            for field_name, field_type in fields.items():
                ...
                Attribute.objects.get_or_create(
                    name=field_name, slug=gen_slug(field_name), datatype=datatypes[field_type],
                )
        ...
        for i in range(1000):
            ...
            print('{}. Created user {} {} ({} abonamente | {} evenimente)'.format(i, entry.eav.nume, entry.eav.prenume, abonamente_count, evenimente_count))
