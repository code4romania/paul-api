...
KEY = "ck_308557d5764432eeab30279ccf7a9add8b21063e"
SECRET = "cs_fde0d9ab211f38cfdb08578566b84f21cf0797e7"
...
if __name__ == "__main__":
    ...
    # the one we iterate through
    data_users = get_data("v3_memberships_members.json")
    
    # the ones we cross-check
    data_memberships = list_to_dict(get_data("v3_memberships_plans.json"), "id")
    data_customers = list_to_dict((get_data("v3_customers.json"))

    data = transform_old_memberships(data_memberships, data_users, data_customers)

    with open("subscriptions_old.json", "w") as f:
        f.write(json.dumps(data, indent=4))

    json_to_csv("FINAL_subscriptions_old.json", "FINAL_subscriptions_old.csv")